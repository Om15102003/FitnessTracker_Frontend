...
const Homebanner1 = () => {
    ...
    function simplifyFraction(numerator:number,denominator:number):[number,number]{
        ...
        const simpilfiedNumerator:number=numerator/commonDivisor;
        const simpilfiedDenominator:number=denominator/commonDivisor;
        return [simpilfiedNumerator,simpilfiedDenominator];
    }
  return (
            ...
            data?.length>0 && data.map((item:any,index:number)=>{
                return (<div className='card' key={index}>
                    <div className="card-header">
                        ...
                        <div className="card-header-box">
                            <div className="card-header-box-name">Taregt</div>
